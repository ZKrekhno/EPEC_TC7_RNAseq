...
counts <- read.table("all_reads_mirDEEP2", header = F, sep = "\t", stringsAsFactors = F)
...
plotPCA(data, col = graph_cols, main = "Unnormalized counts", cex.axis = 1.5, cex.lab = 1.5)
plotPCA(dataOffset, col = graph_cols, main = "Normalized counts", cex.axis = 1.5, cex.lab = 1.5)
plotRLE(data, col = graph_cols, main = "RLE Unnormalized counts", cex.axis = 1.5)
plotRLE(dataOffset, col = graph_cols, main = "RLE Normalized counts", cex.axis = 1.5)
boxplot(data, main = "Unnormalized counts", col = graph_cols, cex.axis = 1.5)
boxplot(dataNorm, main = "Normalized counts", col = graph_cols, cex.axis = 1.5)
#dev.off()
```
...
#png(here::here("final clean figures/PCA plot of normalized counts legend bottom.png"), width = 12, height = 10,
   #units = "in", res = 720)
ggplot(data = normal_PCA, aes(shape = pData$genotype, color = pData$genotype)) +
  ...
  labs(title = "EDASEq-norm DESeq2 PCA plot") +
  scale_shape_manual(name = "Infection",
                     labels = c("N" = paste0(greeks("Delta"),"EscN EPEC"),
                                "WT" = "Wild-type EPEC", "UI" = "Uninfected"),
