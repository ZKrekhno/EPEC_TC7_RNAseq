...
#pdf(here::here("long_infection_human_reads/integrated analysis/results/Venn diagrams of shared differentially expressed miRNA.pdf"), width = 7, height = 5)
ggvenn(de_mirna, show_elements = F, text_size = 5, set_name_size = 6) 
ggvenn(de_mirna, show_elements = T)
#dev.off()
ggvenn(de_mirna, show_elements = F, text_size = 5, set_name_size = 6) 
#ggsave(here::here("long_infection_human_reads/integrated analysis/results/Venn diagrams of shared differentially expressed miRNA.svg"),
 #      width = 7, height = 5)
```
